...
This is an early experiment how to generate an API documentation using RSpec and DSL magic.
...
I want to generate an API documentation something like this from an RSpec Macro DSL.
  ...
  Account
    ...
    Public Instance Methods
      #transfere(5:Fixnum, 'USD':String)
         given Account with 50 USD
           return value: TransactionBuilder transfere 5 USD from Account with 50 USD
             has #target == nil
  ...
  TransactionBuilder
    ...
    Public Instance Methods
      #to(target_account:Account with 0 USD) 
         given TransactionBuilder transfere 5 USD from Account with 50 USD
           target_account 
             has #balance == 5
             has #currency == 'USD'
           #source_account has
