    ...
    Public Instance Methods
      #transfer(5:Fixnum, 'USD':String)
         given Account with 50 USD
           should accept given arguments (5:Fixnum, 'USD':String)
    ...
    context "Public Instance Methods" do
      transfer(5, 'USD') do
        given(Account.new(50,'USD') do
          ...
          it("should not modify balance") { subject.balance.should == 50}
        end
        given(Account.new(0,'USD') do
          throws_exception(SomeExceptionClass)
        end
    end
  end

  fixture "Account with 50 USD" do
